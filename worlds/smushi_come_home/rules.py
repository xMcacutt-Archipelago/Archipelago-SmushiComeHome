...
def get_advanced_rules(world):
  rules = {
    "locations": {
      ...
      "Chungy Saved":
        lambda state: can_save_chungus(world, state) and has_climb_level(world, state, 2)
      ...
      "Ring of Truth Found":
        lambda state: (can_hm01(world, state) and can_fly(world, state) and has_climb_level(world, state, 2))
                      or (can_hm01(world, state) and can_fly(world, state) and has_climb_level(world, state, 1)
      ...
      "Ring of Spirit Found":
        lambda state: has_climb_level(world, state, 1) and can_burn(world, state)
                      and can_go_water(world, state),
      ...
      "Sacred Streamer 4 Obtained (Rings)":
        lambda state: has_climb_level(world, state, 1) and state.has("Ring Returned", world.player, 3),
      ...
      "Mycena Chlorophos":
        lambda state: is_shroom_nerd(world, state) and can_fly(world, state)
                      and has_climb_level(world, state, 1) and can_hm01(world, state),
      ...
      "Psathyrella Aquatica":
        lambda state: is_shroom_nerd(world, state) and can_go_water(world, state),
      ...
      "Clavaria Augmenter":
        lambda state: can_mine(world, state) and can_go_water(world,state),

      "Ink Augmenter":
        lambda state: can_fly(world, state) and has_climb_level(world, state, 1)
                      and can_hm01(world, state),

      "Sharp Augmenter":
        lambda state: can_screw_glass(world, state) and can_fly(world, state)
                      and has_climb_level(world, state, 2) and is_pitch_black_baby(world, state),

      "Precious Augmenter":
        lambda state: has_climb_level(world, state, 1) and state.has("Ring Returned", world.player, 5),

      "Veiled Augmenter":
        lambda state: has_climb_level(world, state, 2) and can_hm01(world, state),

      "Sacred Augmenter":
        lambda state: state.has("Sacred Streamer", world.player, 4) and has_climb_level(world, state, 1),
    },
    "entrances": {
      ...
      f"{BRILLIANT_BEACH} -> {FIREFLIES}":
        lambda state: (state.has("Ring Returned", world.player, 1) or has_climb_level(world, state, 2))
                      and can_fly(world, state),
      f"{LAKE} -> {SMUSHI_HOME}":
...
def get_standard_rules(world):
  rules = {
    "locations": {
      ...
      "Ring of Truth Found":
        lambda state: can_hm01(world, state) and has_climb_level(world, state, 2) and can_fly(world, state),
