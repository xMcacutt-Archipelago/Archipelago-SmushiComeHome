...
progress_locations = {
    ...
    "Super Spore Received":            LocData(0x102, WINTER),
    "Conch Shell Received":            LocData(0x103, SMUSHI_HOME),

    "Garden Map Found":                LocData(0x200, MYCENA_ENTRY),
    "Yellow Shrine Energy Spore":      LocData(0x201, MYCENA_ENTRY),
    "Pink Shrine Energy Spore":        LocData(0x202, BOLETE_BEACH),
    "Blue Shrine Energy Spore":        LocData(0x203, ANCIENT_PASSAGE),
    "Blade of Power Purchase":         LocData(0x204, BOLETE_BEACH),
    "Anemone Woods Wind Essence":      LocData(0x205, ANEMONE_WOODS),
    "Mycology Journal Unlock":         LocData(0x206, MYCENA_ENTRY),
    "Band of Elasticity Found":        LocData(0x207, ANEMONE_WOODS),
    "Myrtle Pools Wind Essence":       LocData(0x208, MYRTLE_POOLS),
    "Myrtle Pools Blueberry Purchase": LocData(0x209, MYRTLE_POOLS),
    "Ancient Relic 1 Found":           LocData(0x20A, MYRTLE_POOLS),
    "Ancient Relic 2 Found":           LocData(0x20B, MYRTLE_POOLS),
    "Crystal Cave Blueberry Found":    LocData(0x20C, CRYSTAL_CAVES),
    "Tool of Writing Found":           LocData(0x20D, MYCENA_ENTRY),
    "Ancient Relics Returned":         LocData(0x20E, MYRTLE_POOLS),
    ...
    "Firestarter Kit Purchase":     LocData(0x307, MAPLE_SANCTUARY),
    ...
    "Chungy Saved":                 LocData(0x403, CHUNGY_CAVE),
    ...
    "Grove Map Found":                         LocData(0x500, LIMINAL_WOODS),
    "Screwdriver Purchase":                    LocData(0x501, ELDERS_HOME),
    "Band Aid Found":                          LocData(0x502, TRANQUIL_GARDEN),
    "Ring of Truth Found":                     LocData(0x503, LIMINAL_WOODS),
    "Ring of Youth Found":                     LocData(0x504, TRANQUIL_GARDEN),
    "Ring of Love Found":                      LocData(0x505, LIMINAL_WOODS),
    "Ring of Prosperity Found":                LocData(0x506, FIREFLIES),
    "Ring of Spirit Found":                    LocData(0x507, BRILLIANT_BEACH),
    "Sacred Streamer 1 Obtained (Rico)":       LocData(0x508, LIMINAL_WOODS),
    "Sacred Streamer 2 Obtained (Web Area)":   LocData(0x509, TRANQUIL_GARDEN),
    "Sacred Streamer 3 Obtained (Underwater)": LocData(0x50A, FIREFLIES),
    "Sacred Streamer 4 Obtained (Rings)":      LocData(0x50B, BRILLIANT_BEACH),
}

mycology_locations = {
    "Mycena Haematopus":          LocData(0x600, MYCENA_ENTRY),
    "Volvopluteus Gloiocephalus": LocData(0x601, MYRTLE_POOLS),
    "Hypholoma Capnoides":        LocData(0x602, ANCIENT_PASSAGE),
    "Macrolepiota Procera":       LocData(0x603, MYRTLE_POOLS),
    "Entoloma Hochstetteri":      LocData(0x604, ANEMONE_WOODS),
    "Chalciporus Piperatus":      LocData(0x605, BOLETE_BEACH),
    ...
    "Hygrocybe Flavescens":       LocData(0x609, WAXCAP_FALLS),
    "Daedaleopsis Tricolor":      LocData(0x60A, CRYPTIC_CAVERNS),
    "Amanita Muscaria":           LocData(0x60B, WAXCAP_FALLS),
    "Exsudoporus Frostii":        LocData(0x60C, MAPLE_SANCTUARY),
    "Clavaria Zollingeri":        LocData(0x60D, SACRED_HOLM),
    "Hygrocybe Conica":           LocData(0x60E, SACRED_HOLM_INNER),
    "Lactarius Indigo":           LocData(0x60F, INDIGO_ISLAND),
    "Psathyrella Aquatica":       LocData(0x610, HIDDEN_LOTUS),
    "Hygrocybe Miniata":          LocData(0x611, LIMINAL_WOODS),
    "Coprinellus Disseminatus":   LocData(0x612, ELDERS_HOME),
    "Phallus Indusiatus":         LocData(0x613, TRANQUIL_GARDEN),
    "Laccaria Amethystina":       LocData(0x614, LIMINAL_WOODS),
    "Coprinellus Domesticus":     LocData(0x615, FIREFLIES),
    "Heart of the Forest":        LocData(0x616, SACRED_TREE),
}
